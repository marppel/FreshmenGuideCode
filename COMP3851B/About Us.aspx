<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.Master" AutoEventWireup="true" CodeBehind="About Us.aspx.cs" Inherits="COMP3851B.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="display : flex ; align-items : center " >
        ...
        <!-- UON Building Image -->  
            <img src="Images/UON%20Building.jpg" style="margin-top : 50px; margin-left: 20px; max-width : 100%"/>
        </div>
        <!-- text beside image -->
        <div>
