...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="margin-top:200px; margin-left: 100px">
        ...
        <div class="container">
            ...
            <asp:DataList ID="DLGde" runat="server" RepeatColumns="4" RepeatDirection="Horizontal">
                <ItemTemplate>
                    <div class="row">
                        <section class="facilities">
                            <div class="facilities-col col-sm-12">
                                ...
                                <asp:LinkButton ID="LinkButton1" runat="server" Text='<%# Bind("gdeTitle") %>' CommandName="Go" CommandArgument='<%# Eval("gdeID") %>' ></asp:LinkButton>
                            </div>
                        </section>
                    </div>
                </ItemTemplate>
